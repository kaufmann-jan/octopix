...
class OpenFOAMresiduals(OpenFOAMpostProcessing):
    ...
    def __init__(self,file_name='residuals.dat',case_dir=None,tmin=None,tmax=None):
        ...
        super().__init__(base_dir='residuals',file_name=file_name,names=names,usecols=None,case_dir=case_dir,scale=None,tmin=tmin,tmax=tmax)
